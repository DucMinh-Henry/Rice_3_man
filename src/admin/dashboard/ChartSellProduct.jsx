...
const data2 = [
    ...
    { label: "Group F", value: 1398, color: "#4ac246" },
    { label: "Group G", value: 9800, color: "#29c9df" },
    { label: "Group H", value: 3908, color: "#ee9f29" },
  ];

const ChartSellProduct = () => {
    return (
        <div className="grid col-start-8 col-end-11 bg-white rounded-lg">
                <div className="p-5">
                  ...
                  <PieChartDashboard data={data2}></PieChartDashboard>
                </div>
              </div>
    );
};

export default ChartSellProduct;